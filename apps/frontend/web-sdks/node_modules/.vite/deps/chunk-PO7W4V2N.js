...
// node_modules/.pnpm/svelte@5.46.1/node_modules/svelte/src/internal/shared/warnings.js
  ...
  if (typeof value === "object" && value !== null) {
    ...
    if (is_array(value)) {
      ...
      for (var i = 0; i < value.length; i += 1) {
        var element = value[i];
        if (i in value) {
          copy[i] = clone(element, cloned, dev_fallback_default ? `${path}[${i}]` : path, paths, null, no_tojson);
        }
      }
      return copy;
    }
...
//# sourceMappingURL=chunk-PO7W4V2N.js.map

...
declare module '$env/static/private' {
	...
	export const PROTO_NODE_DETECTED_FROM: string;
	...
	export const PROTO_PNPM_DETECTED_FROM: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		XPC_FLAGS: string;
		FORCE_COLOR: string;
		PROTO_NODE_DETECTED_FROM: string;
		...
		PROTO_PNPM_DETECTED_FROM: string;
